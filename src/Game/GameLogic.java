...
public class GameLogic { private static Random random = new Random();
    ...
    public String mainLoop(int clX, int clY) {
        ...
        if (clX < SIZE && clY < SIZE && isCellValid(clX, clY) && !isMapFull()
            ...
            if (isMapFull()) title = "XO - Draw!";
                ...
                title = "XO - Choose Another Field!";
            }
        }
        if (checkWin(humanSymb) ) title = "XO - You Win!";
